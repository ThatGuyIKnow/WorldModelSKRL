...
from skrl.agents.torch import Agent, A2C_RNN, A2C_DEFAULT_CONFIG
from skrl.memories.torch import Memory
from skrl.models.torch import Model
from skrl.resources.schedulers.torch import KLAdaptiveLR

class WorldModelA2C(A2C_RNN):
    def __init__(self,
    ...
    def act(self, states: torch.Tensor, timestep: int, timesteps: int) -> torch.Tensor:
        ...
        latent_state, hidden_state = self.world_model.to_latent(states, self.hidden_state)
        self.hidden_state = hidden_state
        # sample stochastic actions
        actions, log_prob, outputs = self.policy.act({"states": latent_state, **rnn}, role="policy")
