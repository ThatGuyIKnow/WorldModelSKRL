...
import torch
from Models.MDNRNN import MDNRNN, MDRNNCell_
...
class RolloutGenerator(object):
    ...
    def __init__(self, mdir, device, time_limit):
        ...
        self.vae = VAE.load_from_checkpoint(Path(vae_dir) / "model.ckpt")
        self.mdrnn = MDNRNN.load_from_checkpoint(Path(mdnrnn_dir) / "model.ckpt", strict=False).cell
